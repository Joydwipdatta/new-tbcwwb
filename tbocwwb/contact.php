...
<head>
    ...
    <title>Contact | TRIPURA BUILDING & OTHER CONSTRUCTION WORKERS WELFARE BOARD</title>
    ...
    <section class="navbar">
        ...
        <div class="mainnav">
            ...
            <div class="navbuttons">
                <a href="#"><button>User login</button></a>
                <a href="#" target="_blank"><button>Admin login</button></a>
...
<!------------------------------------------- Body Section --------------------------------------------->
    ...
    <section class="body-section">
        <div class="body-box">
            <h1>Contact Us</h1>
            <h4>Email: <a href="mailto:tbocwwboard2007@gmail.com">tbocwwboard2007@gmail.com</a></h4>
            <h4> HelpLine: <a href="tel:03812383570">03812383570</a> </h4>
        </div>
    </section>
