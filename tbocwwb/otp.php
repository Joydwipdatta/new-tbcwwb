...
<head>
    ...
    <title>OTP VERIFICATION | TRIPURA BUILDING & OTHER CONSTRUCTION WORKERS WELFARE BOARD</title>
...
if(!empty($_POST['submit'])){  
      ...
      $query="select * from `register` where otp='$otp'";
...
<section class="registration-sec">
  ...
  <input type="tel" id="" name="otp" placeholder="Enter OTP  ..">
                
                <a href="#"><button>Resend OTP</button></a>
